...
public final  class WorkWithFile {
	...
	public static void main(String... arg){
		...
		new WorkWithFile(new Persone("Tretyak", "Alexandr", 3400,12 ),path).saveClass();
		new WorkWithFile(new Persone("Tretyak2", "Alexandr2", 34002,23 ),path1).saveClass();
		new WorkWithFile(new Persone("Tretyak3", "Alexandr3", 34003 ,34),path2).saveClass();
