...
public class FightMain {
	...
	System.out.println("lets Fight! "+ "Поточний iндекс лічильника :: "+ Counter.getСurrentI());
	}
	...
	public static void main(String[] args) throws InterruptedException{
		...
		for(int i = 0 ; i < 10 ; i++){
		 ...
		 System.out.println("Конфлікт завершино ! Поточний iндекс лічильника ::" + Counter.getСurrentI());
